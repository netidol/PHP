...
class DB
{
    ...
    {
        $serverName = env("MYSQL_PORT_3306_TCP_ADDR", "10.10.11.174");
        $databaseName = env("MYSQL_INSTANCE_NAME", "JlRi2kwOsVALd4jn");
        $username = env("MYSQL_USERNAME", "ueEbNyrKpv3cwluM");
        $password = env("MYSQL_PASSWORD", "peuFVaywBXKLgkEjI");
